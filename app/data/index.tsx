...
export const SAMPLE_PFPS = [
  { emoji: "/memes/pans-meme.jpg", label: "$PANS" },
...
export const MEME_TOKENS: MemeToken[] = [
  {
    id: "panda",
    label: "$PANS",
    src: "/memes/pans-meme.jpg",
    accent: "#56727e",
    glow: "rgba(86,114,126,0.6)",
