...
export default function PFPCard({ emoji, label, index }: PFPCardProps) {
  ...
  return (
    <div
      className="pfp-card animate-float group relative "
      style={{
    ...
    >
      ...
      />
      <div
        className="relative w-30 h-35 rounded-[1.25rem] overflow-hidden transition-all duration-300 flex flex-col items-center justify-center"
        style={{ background: `linear-gradient(135deg, ${from}, ${to})` }}
      >
